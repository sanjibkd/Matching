...
import com.walmart.productgenome.matching.utils.FileUtils;
...
public class ProjectDao {
    ...
    public static Project open (String projectName) {
    ...
    public static void deleteProject(String projectName) throws IOException {
        ...
        File dir = new File(Constants.ROOT_DIR + projectName);
        try {
            FileUtils.deleteRecursive(dir);
        } catch (IOException e) {
            System.out.println("[ProjectDao: deleteProject] IOException " +
            		e.getMessage());
            throw e;
        }
