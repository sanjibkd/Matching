...
public class SoundexSimilarityFunction extends Function {
	...
	public SoundexSimilarityFunction() {
		super(NAME, DESCRIPTION);
	}

	public SoundexSimilarityFunction(String name, String description){
		super(name, description);
	}
