...
public class FirstWordsMatch extends Function {
	
	public static final String NAME = "FIRST_WORDS_MATCH";
	public static final String DESCRIPTION = "Returns 1 if first words in A and B match, 0 otherwise";
	public static final int NUM_ARGS = 2;

	public FirstWordsMatch() {
		super(NAME, DESCRIPTION);
	}

	public FirstWordsMatch(String name, String description) {
		super(name, description);
	}
