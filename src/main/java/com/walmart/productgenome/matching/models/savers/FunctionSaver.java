...
public class FunctionSaver {
	...
	public static void deleteFunction(String projectName, Function function)
			throws IOException, SecurityException, IllegalArgumentException,
			ClassNotFoundException, NoSuchMethodException, InstantiationException,
			IllegalAccessException, InvocationTargetException {
		String allFunctionsFilePath = getAllFunctionsFilePath(projectName);
		deleteFunction(function, allFunctionsFilePath);
	}

	public static void deleteFunction(Function function, String allFunctionsFilePath)
			throws IOException, ClassNotFoundException, SecurityException,
			NoSuchMethodException, IllegalArgumentException, InstantiationException,
			IllegalAccessException, InvocationTargetException {
		
		// delete the function in place if it exists
		FileReader r = new FileReader(allFunctionsFilePath);
		CSVParser parser = new CSVParser(r);
		List<CSVRecord> records = parser.getRecords();
		r.close();
