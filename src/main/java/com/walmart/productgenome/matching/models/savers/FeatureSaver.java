...
public class FeatureSaver {
	...
	public static void deleteFeature(String projectName, Feature feature, Project project) throws IOException {
		String allFeaturesFilePath = getAllFeaturesFilePath(projectName);
		deleteFeature(feature, allFeaturesFilePath, project);
	}
